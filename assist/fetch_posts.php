...
// جلب المنشورات
$sql = "SELECT p.*, u.display_name, u.profile_picture, u.id AS user_id
        FROM posts p
...
">
    ...
    <div style="display:flex !important; align-items:center !important; gap:0.5rem !important;">
      ...
      <div>
        <div style="font-weight:600 !important;">
          <a href="profile.php?id=<?= $userId ?>" style="text-decoration:none !important; color:inherit !important;">
            <?= $displayName ?>
          </a>
        </div>
  ...
  <div style="padding:0.5rem 1rem !important;">
    <div class="post-react" style="margin-bottom:0.5rem;">
      <div class="react-top" style="display:flex; align-items:center; justify-content:space-between;">
        ...
        <div style="color:#888;">
          <!-- عداد التعليقات -->
          <span id="commentsCount_<?= $postId ?>">0</span> comments
          <!-- ثابته افتراضيًا -->
          <span style="margin-left:10px;">66 Shares</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="padding:0.5rem 1rem !important;">
    <div class="post-action">
      <div class="action-bar" style="display:flex; justify-content:space-around;">
        <!-- زر الإعجاب -->
        <div class="action-btn like-btn" data-post-id="<?= $postId ?>" style="display:flex; align-items:center; gap:5px; cursor:pointer;">
  ...
  <div style="padding:0.5rem 1rem !important;">
    <div class="comments-section" id="commentsContainer_<?= $postId ?>">
      <!-- سيتم حقن التعليقات والردود ديناميكيًا عبر جافاسكربت -->
    </div>
  </div>
  <!-- END LIST COMMENT -->
